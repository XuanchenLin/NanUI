    ...
    <div className="splash">
      <div className="row">
        ...
        <div className="col-md-3 col-sm-12 info">
          ...
          <p>.NET Core 3.1/.NET 5.0/.NET 6.0 Or .NET Framework 4.6.2+</p>
          <p>
            Based on Chromium Embedded Framework{" "}
            <abbr title="90.0.4430.93">90.6.7</abbr>
          </p>
      ...
      <div className="row">
        <div className="col-md-4">
          <section className="intro easy-to-use">
            ...
            <h4>Easy to Use <img src={social_img} height="64" alt="" /></h4>
        ...
        <div className="col-md-4">
          <section className="intro fully-documentation">
            ...
            <h4>Tutorials<img src={idea_img} height="64" alt="" /></h4>
            <p className="text-black-50">
        ...
        <div className="col-md-4 ">
          <section className="intro new-technology">
            ...
            <h4>The Best Selection<img src={tech_img} height="64" alt="" /></h4>
            <p className="text-black-50">
