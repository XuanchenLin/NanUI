      ...
      <div className="splash">
        <div className="row">
          <div className="col-md-9 col-sm-12 d-flex">
            ...
            <div className="flex-fill">
              <p>
                ...
                Core Windows Form Applications. Mordern web front-end
                technologies can be used to build the application's user
                interface. It allows you to experience the combination of
                front-end frameworks such as React / Vue / Blazor / Angular and
                WinForms.
              </p>
          ...
          <div className="col-md-3 col-sm-12 info">
            ...
            <p>.NET Core 3.1/.NET 5.0+ Or .NET Framework 4.6.2+</p>
            <p>
              Based on Chromium Embedded Framework{" "}
              <abbr title={version.chromium}>{version.chromium}</abbr>
            </p>
        ...
        <div className="row">
          <div className="col-md-4">
            <section className="intro easy-to-use">
              <h4>
                Easy to Use <img src={social_img} height="64" alt="" />
              </h4>

              <p className="text-black-50">
                It only takes a few steps to directly use front-end technology
                to render your application interface. NanUI provides a simple
                and rich API to help you complete the complex Chromium
                configuration and initialization work, which will bring you a
          ...
          <div className="col-md-4">
            <section className="intro fully-documentation">
              ...
              <p className="text-black-50">
                ...
                enrich your development experience. When you encounter problems
                in development, you can also retrieve the community information
          ...
          <div className="col-md-4 ">
            <section className="intro new-technology">
              ...
              <p className="text-black-50">
                NanUI is based on Chromium™. Use the latest Web standards to
                build the interface, so you don't have to waste effort on
                compatibility issues of various versions of browsers. The
                popular front-end framework React / Vue / Blazor / Angular will
                also become a reliable development tool.
              </p>
            </section>
          </div>
        </div>
              ...
              <div className="card-body">
                <div className="media">
                  ...
                  <div className="media-body">
                    ...
                    <p className="text-black-50">
                      Users can choose multiple resource processors for
                      different scenarios to provide files, data, etc. for
                      front-end programs. In addition, you can also develop
                      custom resource processors according to specific needs.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="card-body">
                <div className="media">
                  ...
                  <div className="media-body">
                    ...
                    <p className="text-black-50">
                      The framework provides a variety of window styles, and
                      users can flexibly choose different window styles to
                      achieve different design effects and respond to various
                      business needs.
                    </p>
                  </div>
                </div>
                ...
                <div className="media">
                  ...
                  <div className="media-body">
                    ...
                    <p className="text-black-50">
                      ...
                      events, and you can add various browser-related functions
                      to the application.
                    </p>
                  </div>
                </div>
              ...
              <div className="card-body">
                <div className="media">
                  ...
                  <div className="media-body">
                    ...
                    <p className="text-black-50">
                      Supports the latest HTML5 / CSS3 / JavaScript standards.
                      The rendering effect of NanUI is usually the same as the
                      current corresponding version of Chrome / Edge browser.
                    </p>
                  </div>
                </div>
              </div>
