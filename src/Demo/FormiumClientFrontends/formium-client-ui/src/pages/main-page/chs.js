        ...
        <div className="row">
          <div className="col-md-9 col-sm-12 d-flex">
            ...
            <div className="flex-fill">
              <p>
                NanUI 是一个开放源代码的 .NET / .NET Core
                窗体应用程序（WinForms）界面框架。有了此框架将可以用 HTML / CSS
                /JavaSctript 前端技术来为构建应用程序界面。您将能感受到使用 React /
                Vue / Blazor / Angular 等前端框架和 .NET Windows 窗体应用程序进行混合开发的全新体验。
              </p>

              <p>使用 NanUI 界面框架将给 WinForms 应用程序的设计和开发带来无限种可能！</p>

              <p className="mb-4">
                如果你喜欢此项目，请跳转到 GitHub 或 Gitee 为 NanUI 项目点亮一颗星！
              </p>
          ...
          <div className="col-md-3 col-sm-12 info">
            <p>最低可用于 Microsoft Windows 7 Service Pack</p>
            <p>.NET Core 3.1/.NET 5.0/.NET 6.0  或 .NET Framework 4.6.2+</p>
            <p>
              基于 Chromium 嵌入式框架 <abbr title="90.0.4430.93">90.6.7</abbr>
            </p>
        ...
        <div className="row">
          <div className="col-md-4">
            <section className="intro easy-to-use">
              <h4>上手容易使用简便<img src={social_img} height="64" alt="" /></h4>

              <p className="text-black-50">
                只需几步就可以直接使用前端技术来渲染您的应用程序界面。NanUI
                界面组件提供了简单而丰富的 API 并替您完成了繁琐的 CEF
                配置和初始化工作，它将为您带来愉快的开发过程。此外，我们还将不断地提供周边工具以优化项目开发体验。
              </p>
            </section>
          </div>
          <div className="col-md-4">
            <section className="intro fully-documentation">
              <h4>丰富的文档和教程<img src={idea_img} height="64" alt="" /></h4>
              <p className="text-black-50">
          ...
          <div className="col-md-4 ">
            <section className="intro new-technology">
              ...
              <h4>最佳的技术甄选<img src={tech_img} height="64" alt="" /></h4>
              <p className="text-black-50">
                NanUI 界面组件基于 Chromium™ 内核。可以使用最新的 HTML5 / CSS3 /
                ECMAScript2016 标准来构建 Web
                界面，不必再为各种版本的浏览器兼容性问题耗费精力。当前丰富的前端框架
                React / Vue / Blazor / Angular 也将成为可靠的开发利器。
              </p>
            </section>
          </div>
        </div>
              ...
              <div className="card-body">
                <div className="media">
                  ...
                  <div className="media-body">
                    <h5 className="mt-0">Chromium 核心</h5>
                    <p className="text-black-50">
                      使用相对较新、较稳定的 Chromium 版本，保证了对 Web
                      标准的完整支持，有效避免各种浏览器兼容性问题并提高稳定性。
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="card mb-3">
              <div className="card-body">
                <div className="media">
                  ...
                  <div className="media-body">
                    <h5 className="mt-0">资源处理器</h5>
                    <p className="text-black-50">
                      用户可以针对不同的场景选择多种资源处理器来为前端程序提供文件、数据等。另外，还可以根据具体的需求开发自定义资源处理器。
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="card mb-3">
              <div className="card-body">
                <div className="media">
                  ...
                  <div className="media-body">
                    <h5 className="mt-0">浏览器承载窗体</h5>
                    <p className="text-black-50">
                      框架为提供了多种承载窗体样式可供选择，用户可以灵活选择不同的窗体样式达到不同的设计效果、应对各种业务需求。
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="card mb-3">
              <div className="card-body">
                <div className="media">
                  ...
                  <div className="media-body">
                    <h5 className="mt-0">浏览器功能定制</h5>
                    <p className="text-black-50">
                      NanUI 开放了 Chromium
                      的各种行为处理器接口。通过自定义各个接口的响应事件，为应用程序添加各项浏览器相关功能。
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="card mb-3">
              <div className="card-body">
                <div className="media">
                  ...
                  <div className="media-body">
                    <h5 className="mt-0">Web 渲染标准</h5>
                    <p className="text-black-50">
                      支持最新的 HTML5 / CSS3 / JavaScript
                      标准。通常与当前对应版本的 Chrome / Edge
                      浏览器拥有相同的渲染结果。
                    </p>
                  </div>
                </div>
            ...
            <div className="card mb-3">
              <div className="card-body">
                <div className="media">
                  ...
                  <div className="media-body">
                    <h5 className="mt-0">JavaScript 执行能力</h5>
                    <p className="text-black-50">
                      能方便地执行 JavaScript 代码，并返回结果到 .NET 环境。也能将
                      .NET 对象、方法等注册到 JavaScript 环境中。NanUI
                      目前提供对象注册和扩展注册两种方式来实现以上操作。
                    </p>
                  </div>
                </div>
              </div>
