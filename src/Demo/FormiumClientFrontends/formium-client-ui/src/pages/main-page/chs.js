        ...
        <div className="splash">
          <div className="row">
            <div className="col-md-9 col-sm-12 d-flex">
              ...
              <div className="flex-fill">
                <p>
                  ...
                  窗体应用程序（WinForms）界面框架。有了此框架将可以用 HTML /
                  CSS /JavaSctript
                  前端技术来为构建应用程序界面。您将能感受到使用 React / Vue /
                  Blazor / Angular 等前端框架和 .NET Windows
                  窗体应用程序进行混合开发的全新体验。
                </p>

                <p>
                  使用 NanUI 界面框架将给 WinForms
                  应用程序的设计和开发带来无限种可能！
                </p>

                <p className="mb-4">
                  如果你喜欢此项目，请跳转到 GitHub 或 Gitee 为 NanUI
                  项目点亮一颗星！
                </p>
            ...
            <div className="col-md-3 col-sm-12 info">
              ...
              <p>.NET Core 3.1/.NET 5.0+ 或 .NET Framework 4.6.2+</p>
              <p>
                基于 Chromium 嵌入式框架{" "}
                ...
                <div className="card-body">
                  <div className="media">
                    ...
                    <div className="media-body">
                      ...
                      <p className="text-black-50">
                        能方便地执行 JavaScript 代码，并返回结果到 .NET
                        环境。也能将 .NET 对象、方法等注册到 JavaScript
                        环境中。NanUI
