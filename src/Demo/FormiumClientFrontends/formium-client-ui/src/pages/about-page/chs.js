...
const Page = () => (
  <article>
    ...
    <div className="section-block">
      <p>
        NanUI 界面组件是一个开放源代码的 .NET / .NET Core 窗体应用程序（WinForms）框架。它适用于希望使用 HTML5/CSS3/JavaScript 等前端技术来构建 Windows 窗体应用程序用户界面的 .NET 开发人员。
      </p>
      <p>因为 NanUI 项目基于谷歌公司开源的可嵌入式浏览器框架 Chromium Embedded Framework (CEF)，所以您可以使用各种 Web 前端技术和潮流前端框架 （React/Vue/Angular/Blazor等）来设计和布局您的 .NET 桌面应用程序界面，并通过 NanUI 特有的<b>JavaScript Bridge</b>和<b>数据资源处理器</b>方便地实现浏览器前端与 .NET 后台之间的通信和数据交换。</p>
      <p>使用 NanUI 进行应用程序开发时，您既拥有了 .NET 框架所提供的全部功能，同时还能使用 Web 技术方便快速的制作用户界面。所以，正如 NanUI 的宣传口号一样，使用 NanUI 界面框架将给 WinForms 应用程序的设计和开发带来无限种可能！</p>
    </div>
