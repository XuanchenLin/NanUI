...
public sealed class ChromiumEnvironmentBuiler
{
    ...
    public static string CommonCefRuntimeDirectory => Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.CommonApplicationData), @"NanUI\", CHROMIUM_VERSION);
