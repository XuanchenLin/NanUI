...
using NetDimension.NanUI.Browser.EmbeddedBrowser;
...
internal partial class WebView : ILifeSpanHandler
{
    ...
    private void OnAfterCreated(CefBrowser browser)
    {
        ...
        MessageDispatcher.RegisterMessageHandler(NanUIMessage.WFM_ON_CONTEXT_CREATED, args => ContextCreated(args.Browser, args.Frame));
