...
internal class BrowserApp : CefApp
{
    ...
    public string GetExtensionPipeName()
    {
        ...
        return $"NanUI-ExtensionProxy-{processId}";
    }


    public BrowserApp(NanUIApp app)
    {
    ...
    protected override void OnBeforeCommandLineProcessing(string processType, CefCommandLine commandLine)
    {
        ...
        commandLine.AppendSwitch("user-agent-product", $"Chromium/{CefRuntime.ChromeVersion} NanUI/{Assembly.GetExecutingAssembly().GetName().Version}");
