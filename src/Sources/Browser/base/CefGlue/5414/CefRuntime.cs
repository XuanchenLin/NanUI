...
public static unsafe class CefRuntime
{
    ...
    {
        NetDimension.NanUI.CefGlue.Platform.Windows.NativeMethods.LoadLibraryEx(
            System.IO.Path.Combine(path, "libcef.dll"),
            IntPtr.Zero,
            NetDimension.NanUI.CefGlue.Platform.Windows.LoadLibraryFlags.LOAD_WITH_ALTERED_SEARCH_PATH
            );
    }
