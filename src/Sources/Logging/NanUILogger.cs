...
internal class NanUILogger : ILogger
{
    ...
    /// <summary>Initializes a new instance of the <see cref="NanUILogger" /> class.</summary>
    ...
    public NanUILogger(string? fullFilePath = null, bool logToConsole = false, int maxFileSizeBeforeLogRotation = 10)
    {
