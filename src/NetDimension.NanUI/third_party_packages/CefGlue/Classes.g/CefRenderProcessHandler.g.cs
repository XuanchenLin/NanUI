...
namespace Xilium.CefGlue
{
    ...
    public abstract unsafe partial class CefRenderProcessHandler
    {
        ...
        private cef_render_process_handler_t.on_render_thread_created_delegate _ds4;
        private cef_render_process_handler_t.on_web_kit_initialized_delegate _ds5;
        private cef_render_process_handler_t.on_browser_created_delegate _ds6;
        private cef_render_process_handler_t.on_browser_destroyed_delegate _ds7;
        private cef_render_process_handler_t.get_load_handler_delegate _ds8;
        ...
        protected CefRenderProcessHandler()
        {
            ...
            _ds4 = new cef_render_process_handler_t.on_render_thread_created_delegate(on_render_thread_created);
            _self->_on_render_thread_created = Marshal.GetFunctionPointerForDelegate(_ds4);
            _ds5 = new cef_render_process_handler_t.on_web_kit_initialized_delegate(on_web_kit_initialized);
            _self->_on_web_kit_initialized = Marshal.GetFunctionPointerForDelegate(_ds5);
            _ds6 = new cef_render_process_handler_t.on_browser_created_delegate(on_browser_created);
            _self->_on_browser_created = Marshal.GetFunctionPointerForDelegate(_ds6);
            _ds7 = new cef_render_process_handler_t.on_browser_destroyed_delegate(on_browser_destroyed);
            _self->_on_browser_destroyed = Marshal.GetFunctionPointerForDelegate(_ds7);
            _ds8 = new cef_render_process_handler_t.get_load_handler_delegate(get_load_handler);
            _self->_get_load_handler = Marshal.GetFunctionPointerForDelegate(_ds8);
