...
namespace Xilium.CefGlue
{
    ...
    public abstract unsafe partial class CefClient
    {
        ...
        private cef_client_t.get_context_menu_handler_delegate _ds4;
        private cef_client_t.get_dialog_handler_delegate _ds5;
        private cef_client_t.get_display_handler_delegate _ds6;
        private cef_client_t.get_download_handler_delegate _ds7;
        private cef_client_t.get_drag_handler_delegate _ds8;
        private cef_client_t.get_find_handler_delegate _ds9;
        private cef_client_t.get_focus_handler_delegate _dsa;
        ...
        protected CefClient()
        {
            ...
            _ds4 = new cef_client_t.get_context_menu_handler_delegate(get_context_menu_handler);
            _self->_get_context_menu_handler = Marshal.GetFunctionPointerForDelegate(_ds4);
            _ds5 = new cef_client_t.get_dialog_handler_delegate(get_dialog_handler);
            _self->_get_dialog_handler = Marshal.GetFunctionPointerForDelegate(_ds5);
            ...
            _ds7 = new cef_client_t.get_download_handler_delegate(get_download_handler);
            _self->_get_download_handler = Marshal.GetFunctionPointerForDelegate(_ds7);
            _ds8 = new cef_client_t.get_drag_handler_delegate(get_drag_handler);
            _self->_get_drag_handler = Marshal.GetFunctionPointerForDelegate(_ds8);
            _ds9 = new cef_client_t.get_find_handler_delegate(get_find_handler);
            _self->_get_find_handler = Marshal.GetFunctionPointerForDelegate(_ds9);
            _dsa = new cef_client_t.get_focus_handler_delegate(get_focus_handler);
            _self->_get_focus_handler = Marshal.GetFunctionPointerForDelegate(_dsa);
