...
public class BrowserClient : CefClient
{
    ...
    internal readonly CefRenderHandler _renderHandler;
    ...
    internal BrowserClient(Formium formium)
    {
        ...
        _contextMenuHandler = new WinFormiumContextMenuHandler(_owner, this);
    ...
    protected override bool OnProcessMessageReceived(CefBrowser browser, CefFrame frame, CefProcessId sourceProcess, CefProcessMessage message)
    {
        ...
        if (message.Name == WinFormiumApp.ON_CONTEXT_CREATED)
        {
            _owner.OnContextCreated(browser, frame);
            return true;
        }

        if (_owner.WebView.MessageBridge.OnRenderSideMessage(browser, frame, sourceProcess, message))
        {
            return true;
        }
