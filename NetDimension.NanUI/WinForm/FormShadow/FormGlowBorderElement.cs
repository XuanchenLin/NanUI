...
namespace NetDimension.WinForm.FormShadow
{
	...
	internal class FormGlowBorderElement : IDisposable
	{
		...
		private readonly FormGlowBorderDecorator _decorator;
		...
		internal FormGlowBorderElement(FormShadowDockPositon side, IntPtr parent, FormGlowBorderDecorator decorator)
		{
			_side = side;
